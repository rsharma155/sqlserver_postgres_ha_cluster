...
-- =====================================================
-- CRUD GENERATOR FUNCTIONS (deployed per database)
-- Called by pg_runner.py instead of inline ad-hoc SQL.
-- v2: Expanded — 10+ operations per database with JOINs.
-- =====================================================

\c hotel_booking
\i '/scripts/pg_functions.sql'
